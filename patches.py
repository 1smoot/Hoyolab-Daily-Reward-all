...
from api_helper import get_ds, get_ua, get_device_id, hex_digest, update_device_headers
from patch_decorator import patch, patchable
...
class BaseClient:
    ...
    async def request(
        ...
        **kwargs: typing.Any,
        ...
        update_device_headers(self.hoyolab_id, headers)
        #print("Account ID: %s  Header: %s" % (self.hoyolab_id, headers))
